...
// Check .env file contains expected secrets ahead of app startup
if (!config.isValid()) {
  console.error('Error - .env file is missing one or more secrets');
  process.exit(0);
}
...
app.listen(port, () => {
  console.log(`Candidate adaptor app listening at http://localhost:${port}`);
});
